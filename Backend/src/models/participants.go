...
const (
	OTHERROLE   ParticipantRole = iota // The participant has another role in the event.
...
type Participant struct {
	...
	UserID                       uint            `gorm:"primaryKey"` // The unique identifier of the user.
	Event                        Event           // Referenced Event Object
	EventID                      uint            `gorm:"primaryKey"` // The unique identifier of the event.
	Role                         ParticipantRole `gorm:"not null"`   // The role of the participant in the event.
	Organisation                 *Organisation   // Referenced Organisation Object
	OrganisationID               *int            // The organisation of the participant in the event.
